...
/**
 * MovimientosProveedoresFixture
 *
 */
class MovimientosProveedoresFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'saldo' => ['type' => 'float', 'length' => null, 'precision' => null, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => ''],
        '_constraints' => [
