...
/**
 * ProveedoresNotasPagadasFixture
 *
 */
class ProveedoresNotasPagadasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'nota_proveedor_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
